package com.carper.loans.controller;

import com.carper.loans.constants.LoansConstants;
import com.carper.loans.dto.ErrorResponseDto;
import com.carper.loans.dto.LoansContactInfoDto;
import com.carper.loans.dto.LoansDto;
import com.carper.loans.dto.ResponseDto;
import com.carper.loans.service.ILoansService;
...
@Tag(
    ...
    description = "CRUD REST APIs in DemoBank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
